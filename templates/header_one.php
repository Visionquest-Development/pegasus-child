<?php
	...
	$right_align_nav_items = ( 'on' === pegasus_get_option('nav_right') ) ? 'ms-auto' : 'mx-auto';
...
<div id="header" class="header-container <?php echo $fixed_header_choice; ?> ">
	...
	<div class=" mt-3 mb-4 <?php echo $header_container_check; ?>">
		<nav class="navbar py-2 <?php echo $bootstrap_navbar_expand_class; ?> the-default-nav <?php echo $bootstrap_color_scheme; ?> <?php echo $bootstrap_color_utility; ?>" >
