...
<div id="header" class="header-container <?php echo $fixed_header_choice; ?> ">
	...
	<div class="<?php echo $header_one_top_logo_container; ?>">
		<?php /* <div class="site-branding <?php echo $centerLogo; ?> wow zoomInUp" data-wow-duration="3s" data-wow-delay=".5s" > */ ?>
		<div class="site-branding <?php echo $centerLogo; ?> wow " >
			<?php if( ! empty( $logo ) ) : ?>
			...
			<?php endif; ?>
				...
				<div class="collapse navbar-collapse <?php echo $nav_menu_justify_check; ?>" id="bs-example-navbar-collapse-1">
					...
					<div class="contact-button-container">
						<a href="/contact" class="btn  center d-block vqdev-contact-button wow tada" data-wow-delay="0.3s">Contact</a>
					</div> 
				</div>
