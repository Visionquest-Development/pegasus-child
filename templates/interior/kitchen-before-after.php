<?php
/**
 * Interior - Kitchen Before & After Sections
 *
 * @package pegasus-child
 */

$kitchen_ba_path = get_stylesheet_directory_uri() . '/images/Interior/kitchen/before-and-after';
?>
...
<section id="canton-kitchen-upstairs" class="interior-section py-5">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="canton-kitchen-basement" class="interior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="woodstock-kitchen" class="interior-section py-5">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
