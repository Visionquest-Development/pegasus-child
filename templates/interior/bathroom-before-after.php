<?php
/**
 * Interior - Bathroom Before & After Sections
 *
 * @package pegasus-child
 */

$bath_ba_path = get_stylesheet_directory_uri() . '/images/Interior/bathroom/before-and-after';
?>
...
<section id="alpharetta-bath" class="interior-section py-5">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="atlanta-bath" class="interior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="canton-bath" class="interior-section py-5">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="roswell-master-bath" class="interior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="roswell-mccurry-bath" class="interior-section py-5">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="roswell-ottoson-bath" class="interior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
