				...
				<?php endif; ?>
						...
						<div class="collapse navbar-collapse <?php echo esc_attr( $nav_menu_justify_check ); ?>" id="pegasus_header_two">
							...
							*/
							...
							$client_login_url = 'https://www.ricecapitalfund.com/client-login/';
							...
							<div class="contact-button-container">
								...
								<a href="<?php echo esc_url( $client_login_url ); ?>" class="btn-ricecap-ext btn-ricecap-ext--client-login" target="_blank" rel="noopener noreferrer" data-wow-delay="0.3s">
									Client Login
