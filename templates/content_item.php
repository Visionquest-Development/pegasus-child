...
<div class="content-item-container <?php echo strtolower( $tax ); ?>">
	<article class="article-<?php the_ID(); ?> block-inner ">
		...
		<div class="content-item-image">
			<img src="<?php echo pegasus_image_display( 'thumbnail', '', true ); ?>" alt="">
		</div>
		...
		<div class="content-item-wrapper">
			...
			<div class="content-item-paragraph-content">
				...
				if( isset( $pegasus_excerpt ) ) { ?>
					<p>
						<?php
						$temporary_excerpt = substr( strip_tags( $pegasus_excerpt ), 0, 900 );
				...
				<?php } else {
					...
					$temporary_content = substr( strip_tags( $pegasus_content ), 0, 900 );
