<?php
/**
 * Exterior - Before & After Sections
 *
 * @package pegasus-child
 */

$theme_img_path = get_stylesheet_directory_uri() . '/images/Exterior/before-and-after';
?>

<!-- Blue Ridge Retaining Wall Section -->
<section id="blue-ridge" class="exterior-section py-5 section-alt-bg">
	<div class="container" >
		<div class="row mb-4">
			<div class="col-12">
...
<section id="canton-porch" class="exterior-section py-5" >
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="marietta-roof-siding" class="exterior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="marietta-porch" class="exterior-section py-5" >
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="roswell-siding-gazebo" class="exterior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="roswell-siding-windows" class="exterior-section py-5" >
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="smyrna-porch" class="exterior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="woodstock-hardscaping" class="exterior-section py-5" >
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
...
<section id="woodstock-outdoor-living" class="exterior-section py-5 section-alt-bg">
	<div class="container">
		<div class="row mb-4">
			<div class="col-12">
