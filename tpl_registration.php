	...
	<div id="page-wrap">
		...
		<div class="container pt-5 ">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="register-ticket-container">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/UPGRADE.png" alt="Ticket" class="register-ticket">
					</div>
				</div>
				<div class="col-md-3">	
					<div class="register-ticket-container">
		...
		<div class="container">
			<h2>Wide Receiver Tickets</h2>
			<div class="row">
				<div class="col-md-3">
					<div class="register-ticket-container">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/WR_BASIC.png" alt="Ticket" class="register-ticket">
					</div>
				</div>
				<div class="col-md-3">
					<div class="register-ticket-container">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/WR_UPGRADE.png" alt="Ticket" class="register-ticket">
					</div>
				</div>
