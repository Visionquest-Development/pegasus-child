				...
				<div class="inner-content">
					<div class="content-no-sidebar">
						<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
							...
							<?php 
							//$json = get_stylesheet_directory() . '/data/shorinji_techniques.json';
							...
							/* function displayFlashcards($json) {
								...
								foreach ($flashcards as $card) {
									echo '<div class="flashcard" onclick="this.classList.toggle(\'flipped\')">';
									echo '<div class="front">' . esc_html($card['Title']) . '</div>';
									echo '<div class="back">' . esc_html($card['Description']) . '</div>';
									echo '</div>';
								}
								echo '</div>';
							} */
