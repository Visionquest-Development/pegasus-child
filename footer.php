				...
				<div class="pegasus-footer">
					<footer>
						<section class="rcf-footer-contact" aria-label="Rice Capital Fund contact information">
							<div class="container">
								<div class="rcf-footer-contact__inner">
									<div class="rcf-footer-contact__item">
									...
									<a class="rcf-footer-contact__item" href="mailto:info@ricecapitalfund.com">
										...
										<span>info@ricecapitalfund.com</span>
									</a>
								</div>
							</div>
						</section>
