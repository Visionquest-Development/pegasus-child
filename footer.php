			...
			<div class="<?php echo $final_footer_colophon_class; ?>">
				<div id="colophon" class="site-footer" role="contentinfo">
					<div class="site-info float-left">
						...
						if( $custom_footer ) {
							echo 'Copyright ' . date('Y') . ' ' . $custom_footer;
						} else {
							?>
