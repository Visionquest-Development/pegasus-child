				...
				<div class="pegasus-footer">
					<footer>
						...
						<!-- FOOTER LOGO (Pegasus) -->
						<div class="<?php echo $final_footer_container_class; ?>">
							<div class="pegasus-footer-logo">
								<div class="pegasus-footer-logo-mark"><span>P</span></div>
								<div>
									<div class="pegasus-footer-logo-name">Pegasus</div>
									<div class="pegasus-footer-logo-sub">Free &amp; open source &middot; MIT</div>
								</div>
							</div>
						</div>
