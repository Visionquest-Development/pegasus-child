	...
	<div id="page-wrap">
		...
		<div class="">
			<div class="home-hero-slider">
				...
				[slide class="testing"]<img class="alignnone size-full wp-image-12" src="https://test.outlawcoffeecompany.com/wp-content/uploads/2024/07/slider2.jpg" alt="Gold-and-Black-Logo">[/slide]
				[slide]<img class="alignnone size-full wp-image-12" src="https://test.outlawcoffeecompany.com/wp-content/uploads/2024/07/slider3.jpg" alt="Gold-and-Black-Logo">[/slide]
				[/slider]' ); */
				?>
			</div>
		</div>
		...
		<section class="jumbotron text-center">
			<div class="container">
				...
				<p>
					<a href="/online-shop/" class="btn btn-primary my-2">CLICK HERE FOR THE ONLINE SHOP</a>
