		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="inner-content">	
						...
						?>
							<a href="/meet-our-dogs">Back to Meet our Dogs</a>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<hr>
					<p>Our Pal's Place adoption process is called "Companion Match" <a class="" href='/companion-match/'>Learn More</a></p>
					
					<p>If you are interested in <?php wp_title( '' ); ?>...</p>
					<ul>
						<li>
							Come Meet him/her Saturday &amp; Sundays 1:00-5:00pm or weekday by appointment
						</li>
						<li>
							Complete the <a href="/companion-match-form/">Companion Match Form</a> which helps us determine if she/he is a good match for you
						</li>
					</ul>
