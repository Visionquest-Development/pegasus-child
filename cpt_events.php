...
function ulg_events_metabox() {
	...
	$cmb->add_field( array(
		...
		'type'         => 'select',
		'options'      => array(
			''                           => __( 'Type of Event', 'pegasus-bootstrap' ),
			'Alumni'                     => __( 'Alumni', 'pegasus-bootstrap' ),
			'Bachelor / Bachelorette'    => __( 'Bachelor / Bachelorette', 'pegasus-bootstrap' ),
			'Birthday'                   => __( 'Birthday', 'pegasus-bootstrap' ),
			'Cocktail Reception'         => __( 'Cocktail Reception', 'pegasus-bootstrap' ),
			'Corporate Lunch'            => __( 'Corporate Lunch', 'pegasus-bootstrap' ),
			'Engagement'                 => __( 'Engagement', 'pegasus-bootstrap' ),
			'Fundraiser'                 => __( 'Fundraiser', 'pegasus-bootstrap' ),
			'Graduation'                 => __( 'Graduation', 'pegasus-bootstrap' ),
			'Holiday'                    => __( 'Holiday', 'pegasus-bootstrap' ),
			'Meeting / Presentation'     => __( 'Meeting / Presentation', 'pegasus-bootstrap' ),
			'Photo / Film Shoot'         => __( 'Photo / Film Shoot', 'pegasus-bootstrap' ),
			'Private Dinner'             => __( 'Private Dinner', 'pegasus-bootstrap' ),
			'Rehearsal Dinner'           => __( 'Rehearsal Dinner', 'pegasus-bootstrap' ),
			'Shower'                     => __( 'Shower', 'pegasus-bootstrap' ),
			'Sporting Event'             => __( 'Sporting Event', 'pegasus-bootstrap' ),
			'Wedding'                    => __( 'Wedding', 'pegasus-bootstrap' ),
			'Other'                      => __( 'Other', 'pegasus-bootstrap' ),
		),
		'show_in_rest' => WP_REST_Server::ALLMETHODS,
	) );
